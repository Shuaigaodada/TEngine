...
class SocketServer:
    ...
    def find( self, __noc: Union[str, socket, SSClient] ) -> SSClient: ...
    ...
    def recv( self, __size: Optional[int] = None, __flag: int = 0, *, once: bool = False ) -> Optional["Converter"]: ...
    def send_to( self, __c: SSClient, __d: Any, __flag: int = 0, *, convert: bool = True ) -> None: ...
    def send( self, __d: Any, __flag: int = 0, *, convert: bool = True ) -> None: ...
